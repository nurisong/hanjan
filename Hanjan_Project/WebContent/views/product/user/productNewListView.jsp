...
<%
	ArrayList<Product> productNewList = (ArrayList<Product>)request.getAttribute("productNewList");
%>
					...
					<div class="detail-filter">
						<div class="detail-wrapper flex">
							<div class="search-result flex">
								<div></div>
								<div>총&nbsp;</div>
								<div class="search-result-div"><%= productNewList.size() %></div>
								<div>건의 결과가 있어요</div>
							</div>
						</div>
					</div>
