...
<body>
    ...
    <div class="outer">
        ...
        <div class="main-area">
            <div id="title">신규 배송지 추가</div>
                <div id="title-line"><hr></div>
                <div class="info-area">
                    <form action="<%= contextPath %>/insertShip.me" method="post" id="info-form">
                        ...
                        <table class="info-form" align="center">
                            ...
                            <tr>
                                <td>성명</td>
                                <td><input type="text" name="recipient" required placeholder="수령인" ></td>
                            </tr>
                
                            <tr>
                                <td>주소</td>
                                <td>
                                    <span><input type="text" name="postcode" id="sample6_postcode" placeholder="우편번호" required readonly style="width: 100px; text-align: center; margin-right: 10px;"></span>
                                    <span><input type="button" id="gray-btn" onclick="sample6_execDaumPostcode()" style="width: 100px;" value="우편번호 찾기"></span>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td><input type="text" name="address" id="sample6_address" readonly placeholder="주소"></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td><input type="text" name="detailAddress" id="sample6_detailAddress" required placeholder="상세주소"></td>
                            </tr>
                            ...
                            <tr>
                                <td>연락처</td>
                                <td><input type="text" name="phone" maxlength="13" oninput="this.value=this.value.replace(/[^-0-9]/g,'');" required placeholder="- 포함해서 입력해주세요"></td>
                            </tr>
                            <tr>
                                <td colspan="2" id="">
                            ...
                            <tr>
                                <td colspan="2" align="center" class="button-area">
                                    <span><button type="submit" >등록하기</button></span>
