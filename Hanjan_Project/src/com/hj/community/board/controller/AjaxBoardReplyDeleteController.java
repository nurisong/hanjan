...
/**
 * Servlet implementation class AjaxBoardReplyDeleteController
 */
@WebServlet("/rDelete.bo")
public class AjaxBoardReplyDeleteController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxBoardReplyDeleteController() {
        super();
