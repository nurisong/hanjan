    ...
    <div class="orderWrap">
        <div class="orderInner">
            ...
            <form action="<%= contextPath %>/insertOrder.or" method="post">
            	...
            	<input type="hidden" name="orderCount" value= "<%= product.getOrderCount() %>">
            	<input type="hidden" name="orderPrice" value= "<%= (Integer.parseInt(product.getProductPrice()) * product.getOrderCount()) + 3000  %>">
            	<input type="hidden" name="shipNo" value= "<%= shipment.getShipNo() %>">
                ...
                <div class="orderContent">
                                ...
                                <div class="addressInfoWrap">
                                    <div class="addressInfoBox">
                                        <div class="reciverInfo">
                                            <span class="name" style="display: inline-block;"><%=shipment.getRecipient() %></span> <!--유저이름recipient-->
                                            <span class="phone"><%= shipment.getPhone() %></span>    <!--전화번호-->
                                        </div>
                                        <div class="addressInfo">
                                            <span><%=shipment.getAddress() %></span>  <!-- 유저 주소-->
                                            <span>&nbsp;<%=shipment.getDetailAddress() %></span> <!-- 상세주소 -->
                                        </div>
                                    </div>
                    ...
                    <div class="productWrap">
                        ...
                        <div class="productBox">
                            <div class="product1">
                                ...
                                <div class="productInfoWrap">
                                    <div class="productName"><%= product.getProductName() %></div> <!-- 상품명-->
                                    <div class="productNameOption" style="font-weight: 100;"><%= product.getProductAlcohol() %>%, 350ml</div> <!--용량과 정보-->
                                    <div class="price-amount" style="margin-top:10px; font-size:11px; line-height:11px;">
                                        <span><%= product.getProductPrice() %>원</span>   <!-- 상품가격-->
                                        <span><%= product.getOrderCount() %>개</span>  <!--수량-->
                                    </div>
                                </div>
                            </div>
                            <hr style="margin:0px 0px 20px;">
                        ...
                        <div class="totalPrice">
                            ...
                            <div style="font-size: 13px; font-weight:bold;">
                                <%= (Integer.parseInt(product.getProductPrice()) * product.getOrderCount()) + 3000  %> 원 <!-- 상품가격 + 배송비 3000원-->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="billWrap">
                        ...
                        <div class="billContent">
                            ...
                            <div class="billflex">
                                ...
                                <div class="value"><%= (Integer.parseInt(product.getProductPrice()) * product.getOrderCount()) %>원</div>    <!-- 상품의 가격-->
                            </div>
                            <div class="billflex">
                        ...
                        <div class="billFinal">
                            ...
                            <div style="color: rgb(63,72,187); font-weight: 700; font-size: 16px;"><%= (Integer.parseInt(product.getProductPrice()) * product.getOrderCount()) + 3000  %>원</div>    <!-- (총상품금액 + 배송비) - 적립금사용만큼-->
                        </div>
                    ...
                    <div class="payAgreeWrap">
                        <button type="submit" class="agreebtn">
                            <%= (Integer.parseInt(product.getProductPrice()) * product.getOrderCount()) + 3000  %>원 결제하기    <!-- 442행의 값을 버튼에 추가-->
                        </button>
                    </div>
