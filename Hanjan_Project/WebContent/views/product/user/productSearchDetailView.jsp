...
<%
	ArrayList<Product> searchResultList = (ArrayList<Product>)request.getAttribute("searchResultList");
					...
					<div class="detail-filter">
						<div class="detail-wrapper flex">
							<div class="search-result flex">
								<div>"<%= keyword %>"로 검색한</div>
								<div>총&nbsp;</div>
								<div class="search-result-div"><%= searchResultList.size() %></div>
								<div>건의 결과가 있어요</div>
							</div>
						</div>
					</div>
							...
							<div class="component" style="height : auto;">
								<div class="search-DataListWrapper">
									...
									<% if (searchResultList.isEmpty()) { %>
										...
										<!-- 상품-->
									<% } else {  %>
										<% for (Product p : searchResultList) { %>
														...
														<div class="pimgwrapper">
															<div class="search-productPrice">
																...
																<div class="search-review-wrap flex">
																	...
																	<p class="rateReview">판매량 <%= p.getProductCount() %></p>
																</div>
															</div>
