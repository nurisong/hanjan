...
<%
	ArrayList<Product> productBestList = (ArrayList<Product>)request.getAttribute("productBestList");
%>
					...
					<div class="detail-filter">
						<div class="detail-wrapper flex">
							<div class="search-result flex">
								<div></div>
								<div>총&nbsp;</div>
								<div class="search-result-div"><%= productBestList.size() %></div>
								<div>건의 결과가 있어요</div>
							</div>
						</div>
					</div>
						...
						<div class="component-outerdiv">
							<div class="component" style="height : auto;">
								<div class="search-DataListWrapper">
									...
									<% if (productBestList.isEmpty()) { %>
									
										<h1>아무것도없다고</h1>
										
										<!-- 상품-->
									<% } else {  %>
										<% for (Product p : productBestList) { %>
