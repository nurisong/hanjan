...
<%
	ArrayList<Product> productTypeList = (ArrayList<Product>)request.getAttribute("productTypeList");
%>
					...
					<div class="detail-filter">
						<div class="detail-wrapper flex">
							<div class="search-result flex">
								<div><%= productTypeList.get(0).getProductType() %></div>
								<div>로 찾은 총&nbsp;</div>
								<div class="search-result-div"><%= productTypeList.size() %></div>
								<div>건의 결과가 있어요</div>
							</div>
						</div>
					</div>
